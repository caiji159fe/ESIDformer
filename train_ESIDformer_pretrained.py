...
class Trainer:
    ...
    def train(self):
        self._init_params()
        start_epoch = 0
        if os.path.exists('last_ESIDformer_pretrained.pth'):
            print('load_pretrained')
            training_state = (torch.load('last_ESIDformer_pretrained.pth'))
...
if __name__ == '__main__':
    with open('config/config_ESIDformer_pretrained.yaml', 'r') as f:
